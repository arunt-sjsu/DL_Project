...
sys.path.insert(0, "D:/Learning/Fall2020/Spring2021/DeepLearning/Project/DLCode/Virtual-Try-On-master/LIP_JPPNET")
from utils import *
...
def JPPNet_parsing(image_dir, checkpoint_dir, output_dir):
    ...
    with tf.name_scope("create_inputs"):
        reader = ImageReader(image_dir, None, False, False, coord)
        image = reader.image
    ...
    if checkpoint_dir is not None:
        if load(loader, sess, checkpoint_dir):
            print(" [*] Load SUCCESS")
        else:
            print(" [!] Load failed...")
