...
import time
import sys
sys.path.insert(0, "D:/Learning/Fall2020/Spring2021/DeepLearning/Project/DLCode/Virtual-Try-On-master/cp_vton")
...
def get_opt():
    ...
    parser.add_argument("--imname", default = "")
    parser.add_argument("--cname", default="")
